...
export default function DashboardSpeedometer() {
    ...
    return (
        <div className={`grid ${user?.role_id == "adm" ? 'grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4': 'grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 '} gap-2.5 w-full`}>  
            ...
            <Parameter satuan="mg/L" value={+dataMonitoring.DO.toFixed(2)} name="DO" time={dataMonitoring.time}/>
            ...
            <Parameter satuan="m" value={+dataMonitoring.DEPTH.toFixed(2)} name="Kedalaman" time={dataMonitoring.time}/> 
            ...
            <Parameter satuan="mg/L" value={+dataMonitoring["NO3-3"].toFixed(2)} name="Nitrat" time={dataMonitoring.time} />
