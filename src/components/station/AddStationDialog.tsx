...
import { PayloadStationServiceType, PayloadStationType } from "../../types/typeStation"
...
export const AddStationDialog =({ isOpen, handleOpen }: PropAddTypeDialog)=>{
    ...
    const muttation = useMutation({
        mutationFn: (payload: PayloadStationServiceType)=> addStationService(payload),
        mutationKey: ["station"],
        onSuccess: (data)=>{
    ...
    return (
        <Dialog  size="xs" open={isOpen} handler={handleOpen}>
            <DialogHeader>Tambah Stasiun</DialogHeader>
